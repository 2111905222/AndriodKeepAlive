...
function getQAname() {
    ...
    // 获取侧边栏元素
    var guideinbox = document.getElementById("add-box-qain");
    // 显示侧边栏
    guideinbox.style.display = 'block';
    // 添加遮挡层
    addCover(parent);

    var confirmBtn = document.getElementById("save-button-qain");
    var cancelBtn = document.getElementById("cancel-button-qain");

    var name = document.getElementById("qa-txtfile");
    var guidein_name = document.getElementById("qain-name");
    var pullsidebar_guidein_name = document.getElementById("pullsidebar-qain-name");

    confirmBtn.onclick = function () {
        if (name.value == "") {
            name.value = "必须输入问题组名称";
...
function add_qain() {
    ...
    addCover(parent);
    var pullsidebar_guidein_name = document.getElementById("pullsidebar-qain-name");
    pullsidebar_guidein_name.value = document.getElementById("qain-name").value;
}
...
function removeqaviewbj() {
    ...
    text.style.display = "none";
    var im = document.getElementById("qa-im-bj");
    im.style.display = "none";
    ...
    bt_text.style.color = "#fff";
    var bt_im = document.getElementById("way-im-bj");
    bt_im.style.color = "#fff";
...
function addtrqabj(index) {
    ...
    var way_im = document.getElementById("qa-im-bj");
